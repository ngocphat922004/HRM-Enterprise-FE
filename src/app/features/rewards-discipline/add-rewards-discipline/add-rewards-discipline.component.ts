                ...
                error: (
                    ...
                    this.errorMessage =
                        this.getApiErrorMessage(
                            ...
                            'Không thể tải dữ liệu tạo quyết định.',
                        );
        ...
        this.khenThuongKyLuatService
            ...
            .subscribe({
                ...
                next: (
                    ...
                    this.showToast(
                        `Đã tạo quyết định ${this.formatDecisionCode(
                            created.maKTKL,
                        )} thành công.`,
                    );
    ...
    private getApiErrorMessage(
        ...
        error.status
            ...
            case 403:
                ...
                return (
                    'Bạn không có quyền tạo quyết định.'
                );

            case 404:

                return (
                    'Không tìm thấy nhân viên hoặc dữ liệu liên quan.'
                );
